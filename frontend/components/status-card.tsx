...
export function StatusCard({ stats, poolData }: StatusCardProps) {
  ...
  return (
    <section className="flex h-full flex-1 flex-col gap-6 rounded-4xl border border-white/75 bg-white/95 p-6 shadow-[0_28px_80px_rgba(76,99,237,0.18)] backdrop-blur-2xl sm:p-7">
      <div>
